-- ============================================================
-- Migration 016: Restrict backup restore to ledger owner only
-- Restoring a backup is a destructive operation that replaces
-- all data — only the ledger owner should be able to do this.
-- ============================================================
...
DECLARE
  ...
  v_student_id uuid;
BEGIN
  -- Verify caller is the OWNER of this ledger (not just any member)
  IF NOT EXISTS (
