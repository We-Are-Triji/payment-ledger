-- Update restore_backup to handle new payment fields (method, voided_at)
-- Backward compatible: old backups without these fields default to 'manual' and null
...
begin
  ...
  -- 5. Insert payments with mapped student IDs (handles method + voided_at)
